...
@frozen
public struct Zip13SequenceDifferentiable<C1: Collection, C2: Collection, C3: Collection, C4: Collection, C5: Collection, C6: Collection, C7: Collection, C8: Collection, C9: Collection, C10: Collection, C11: Collection, C12: Collection, C13: Collection> where C1.Index == Int, C2.Index == Int, C3.Index == Int, C4.Index == Int, C5.Index == Int, C6.Index == Int, C7.Index == Int, C8.Index == Int, C9.Index == Int, C10.Index == Int, C11.Index == Int, C12.Index == Int, C13.Index == Int {@usableFromInline
...
_ collection11: C11,
_ collection12: C12,
_ collection13: C13    ) {self._collection1 = collection1
...
extension Zip13SequenceDifferentiable: Collection {
    public typealias Element = (C1.Element, C2.Element, C3.Element, C4.Element, C5.Element, C6.Element, C7.Element, C8.Element, C9.Element, C10.Element, C11.Element, C12.Element, C13.Element)
...
extension Zip13SequenceDifferentiable: Sendable where C1: Sendable,
C2: Sendable,
C3: Sendable,
C4: Sendable,
C5: Sendable,
...
@inlinable
public func _vjpDifferentiableZip<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13>(_ collection1: C1,
_ collection2: C2,
_ collection3: C3,
_ collection4: C4,
_ collection5: C5,
...
_ collection13: C13
    ...
    pullback: (Zip13SequenceDifferentiable<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13>.TangentVector) -> (C1.TangentVector, C2.TangentVector, C3.TangentVector, C4.TangentVector, C5.TangentVector, C6.TangentVector, C7.TangentVector, C8.TangentVector, C9.TangentVector, C10.TangentVector, C11.TangentVector, C12.TangentVector, C13.TangentVector)
) where
C1: Differentiable,
...
_collection13.move(by: offset.collection13)    }
    ...
    @inlinable
    public func differentiableMap<Result: Differentiable>(_ transform: @differentiable(reverse) (C1.Element, C2.Element, C3.Element, C4.Element, C5.Element, C6.Element, C7.Element, C8.Element, C9.Element, C10.Element, C11.Element, C12.Element, C13.Element) -> Result
    ) -> [Result] {
        self.map(transform)
    }
    ...
    @inlinable
    public func _vjpDifferentiableMap<Result: Differentiable>(_ transform: @differentiable(reverse) (C1.Element, C2.Element, C3.Element, C4.Element, C5.Element, C6.Element, C7.Element, C8.Element, C9.Element, C10.Element, C11.Element, C12.Element, C13.Element) -> Result
    ) -> (value: [Result], pullback: ([Result].TangentVector) -> TangentVector) {
        var results: [Result] = []
        results.reserveCapacity(self.count)
        var pullbacks: [(Result.TangentVector) -> (C1.Element.TangentVector, C2.Element.TangentVector, C3.Element.TangentVector, C4.Element.TangentVector, C5.Element.TangentVector, C6.Element.TangentVector, C7.Element.TangentVector, C8.Element.TangentVector, C9.Element.TangentVector, C10.Element.TangentVector, C11.Element.TangentVector, C12.Element.TangentVector, C13.Element.TangentVector)] = []
...
var collection13: C13.TangentVector
        @inlinable
        init(_ collection1: C1.TangentVector, _ collection2: C2.TangentVector, _ collection3: C3.TangentVector, _ collection4: C4.TangentVector, _ collection5: C5.TangentVector, _ collection6: C6.TangentVector, _ collection7: C7.TangentVector, _ collection8: C8.TangentVector, _ collection9: C9.TangentVector, _ collection10: C10.TangentVector, _ collection11: C11.TangentVector, _ collection12: C12.TangentVector, _ collection13: C13.TangentVector) {self.collection1 = collection1
...
@inlinable
public func differentiableZipWith<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, Result>(_ c1: C1,
_ c2: C2,
_ c3: C3,
_ c4: C4,
_ c5: C5,
...
_ c11: C11,
_ c12: C12,
_ c13: C13,    with transform: @differentiable(reverse) (C1.Element, C2.Element, C3.Element, C4.Element, C5.Element, C6.Element, C7.Element, C8.Element, C9.Element, C10.Element, C11.Element, C12.Element, C13.Element) -> Result
) -> [Result] where
...
C13.Element: Differentiable,    Result: Differentiable
{
...
@inlinable
public func _vjpDifferentiableZipWith<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, Result>(_ c1: C1,
_ c2: C2,
_ c3: C3,
_ c4: C4,
_ c5: C5,
...
_ c12: C12,
_ c13: C13,    with transform: @differentiable(reverse) (C1.Element, C2.Element, C3.Element, C4.Element, C5.Element, C6.Element, C7.Element, C8.Element, C9.Element, C10.Element, C11.Element, C12.Element, C13.Element) -> Result
) -> (value: [Result], pullback: ([Result].TangentVector) -> (C1.TangentVector, C2.TangentVector, C3.TangentVector, C4.TangentVector, C5.TangentVector, C6.TangentVector, C7.TangentVector, C8.TangentVector, C9.TangentVector, C10.TangentVector, C11.TangentVector, C12.TangentVector, C13.TangentVector)) where
C1: DifferentiableCollection,
C1.Element: Differentiable,
C2: DifferentiableCollection,
C2.Element: Differentiable,
    ...
    Result: Differentiable
{
    ...
    if count == 0 {
        return (value: [], pullback: { v in (C1.TangentVector(), C2.TangentVector(), C3.TangentVector(), C4.TangentVector(), C5.TangentVector(), C6.TangentVector(), C7.TangentVector(), C8.TangentVector(), C9.TangentVector(), C10.TangentVector(), C11.TangentVector(), C12.TangentVector(), C13.TangentVector()) })
    }
