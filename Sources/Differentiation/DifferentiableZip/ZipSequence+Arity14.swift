...
extension Zip14SequenceDifferentiable: Collection {
    ...
    public subscript(index: Int) -> Element {
        (
            ...
            _collection14[_collection14.startIndex.advanced(by: index)]
        )
    }
    ...
    C14.TangentVector.Element == C14.Element.TangentVector
{
    ...
    public func _vjpDifferentiableMap<Result: Differentiable>(
        ...
        let results = [Result](unsafeUninitializedCapacity: count) { buffer, initializedCount in
            ...
            var c14i = _collection14.startIndex
            ...
            for i in 0 ..< count {
                ...
                _collection14.formIndex(after: &c14i)
            }
        ...
        return (
            ...
            pullback: { v in
                ...
                let tangents14 = C14.TangentVector(count: n) { i in scratch14.moveElement(from: i) }
