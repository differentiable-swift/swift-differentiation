...
@inlinable
public func fusedZip<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, Result>(
    _ c1: C1,
    _ c2: C2,
    _ c3: C3,
    _ c4: C4,
...
@inlinable
public func _vjpFusedZip<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, Result>(
    _ c1: C1,
    _ c2: C2,
    _ c3: C3,
    _ c4: C4,
    ...
    C10.Element.TangentVector: ScalableByBinaryFloatingPoint,
    C11.Element.TangentVector: ScalableByBinaryFloatingPoint,
    C12.Element.TangentVector: ScalableByBinaryFloatingPoint,
    C13.Element.TangentVector: ScalableByBinaryFloatingPoint,
    C14.Element.TangentVector: ScalableByBinaryFloatingPoint
{
    var count = c1.count
    ...
    var gradients10Storage: [C10.Element.TangentVector]!
    var gradients11Storage: [C11.Element.TangentVector]!
    var gradients12Storage: [C12.Element.TangentVector]!
    var gradients13Storage: [C13.Element.TangentVector]!
    var gradients14Storage: [C14.Element.TangentVector]!
                                ...
                                gradients7Storage = [C7.Element.TangentVector](unsafeUninitializedCapacity: count) { gradients7Buffer,
                                    ...
                                    gradients8Storage = [C8.Element.TangentVector](unsafeUninitializedCapacity: count) { gradients8Buffer,
                                        ...
                                        gradients9Storage = [C9.Element.TangentVector](unsafeUninitializedCapacity: count) {
                                            ...
                                            gradients10Storage = [C10.Element.TangentVector](unsafeUninitializedCapacity: count) {
                                                gradients10Buffer, initializedCount10 in
                                                gradients11Storage = [C11.Element.TangentVector](unsafeUninitializedCapacity: count) {
                                                    gradients11Buffer, initializedCount11 in
                                                    gradients12Storage = [C12.Element.TangentVector](unsafeUninitializedCapacity: count) {
                                                        gradients12Buffer, initializedCount12 in
                                                        gradients13Storage =
                                                            [C13.Element.TangentVector](unsafeUninitializedCapacity: count)
                                                        {
                                                            gradients13Buffer, initializedCount13 in
                                                            gradients14Storage =
                                                                [C14.Element.TangentVector](unsafeUninitializedCapacity: count)
                                                            {
                                                                gradients14Buffer, initializedCount14 in
                                                                var c1i = c1.startIndex
                                                                var c2i = c2.startIndex
                                                                var c3i = c3.startIndex
                                                                var c4i = c4.startIndex
                                                                ...
                                                                for i in 0 ..< count {
                                                                    ...
                                                                    gradients10Buffer.initializeElement(at: i, to: g10)
                                                                    gradients11Buffer.initializeElement(at: i, to: g11)
                                                                    gradients12Buffer.initializeElement(at: i, to: g12)
                                                                    gradients13Buffer.initializeElement(at: i, to: g13)
                                                                    gradients14Buffer.initializeElement(at: i, to: g14)
                                                                ...
                                                                initializedCount10 = count
                                                                initializedCount11 = count
                                                                initializedCount12 = count
                                                                initializedCount13 = count
                                                                initializedCount14 = count
                                                            }
                                                        }
                                                    }
                                                }
    ...
    let gradients10: [C10.Element.TangentVector] = gradients10Storage
    let gradients11: [C11.Element.TangentVector] = gradients11Storage
    let gradients12: [C12.Element.TangentVector] = gradients12Storage
    let gradients13: [C13.Element.TangentVector] = gradients13Storage
    let gradients14: [C14.Element.TangentVector] = gradients14Storage
    ...
    return (
        ...
        pullback: { v in
            ...
            return v.withUnsafeContiguousStorage { vBuffer in
                ...
                let tangents10 = C10.TangentVector.building(count: n) { i in gradients10[i].scaled(by: vBuffer[i]) }
                let tangents11 = C11.TangentVector.building(count: n) { i in gradients11[i].scaled(by: vBuffer[i]) }
                let tangents12 = C12.TangentVector.building(count: n) { i in gradients12[i].scaled(by: vBuffer[i]) }
                let tangents13 = C13.TangentVector.building(count: n) { i in gradients13[i].scaled(by: vBuffer[i]) }
                let tangents14 = C14.TangentVector.building(count: n) { i in gradients14[i].scaled(by: vBuffer[i]) }
                return (
                    tangents1,
                    tangents2,
                    tangents3,
