// MARK: Zip14SequenceDifferentiable@inlinable
public func differentiableZip<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Collection9, Collection10, Collection11, Collection12, Collection13, Collection14>(_ collection1: Collection1,
...
_ collection14: Collection14
) -> Zip14SequenceDifferentiable<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Collection9, Collection10, Collection11, Collection12, Collection13, Collection14> {
    Zip14SequenceDifferentiable(collection1, collection2, collection3, collection4, collection5, collection6, collection7, collection8, collection9, collection10, collection11, collection12, collection13, collection14)
}

@frozen
public struct Zip14SequenceDifferentiable<Collection1: Collection, Collection2: Collection, Collection3: Collection, Collection4: Collection, Collection5: Collection, Collection6: Collection, Collection7: Collection, Collection8: Collection, Collection9: Collection, Collection10: Collection, Collection11: Collection, Collection12: Collection, Collection13: Collection, Collection14: Collection> where Collection1.Index == Int, Collection2.Index == Int, Collection3.Index == Int, Collection4.Index == Int, Collection5.Index == Int, Collection6.Index == Int, Collection7.Index == Int, Collection8.Index == Int, Collection9.Index == Int, Collection10.Index == Int, Collection11.Index == Int, Collection12.Index == Int, Collection13.Index == Int, Collection14.Index == Int {@usableFromInline
...
@usableFromInline
internal var _collection14: Collection14
    @inlinable
...
_ collection12: Collection12,
_ collection13: Collection13,
_ collection14: Collection14    ) {self._collection1 = collection1
...
extension Zip14SequenceDifferentiable: Collection {
    public typealias Element = (Collection1.Element, Collection2.Element, Collection3.Element, Collection4.Element, Collection5.Element, Collection6.Element, Collection7.Element, Collection8.Element, Collection9.Element, Collection10.Element, Collection11.Element, Collection12.Element, Collection13.Element, Collection14.Element)
    ...
    public var endIndex: Int {
        Swift.min(_collection1.count, _collection2.count, _collection3.count, _collection4.count, _collection5.count, _collection6.count, _collection7.count, _collection8.count, _collection9.count, _collection10.count, _collection11.count, _collection12.count, _collection13.count, _collection14.count)
    }
    
    @inlinable
    public subscript(index: Int) -> Element {
        (_collection1[index], _collection2[index], _collection3[index], _collection4[index], _collection5[index], _collection6[index], _collection7[index], _collection8[index], _collection9[index], _collection10[index], _collection11[index], _collection12[index], _collection13[index], _collection14[index])
    }
...
extension Zip14SequenceDifferentiable: Sendable where Collection1: Sendable,
...
@inlinable
public func _vjpDifferentiableZip<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Collection9, Collection10, Collection11, Collection12, Collection13, Collection14>(_ collection1: Collection1,
_ collection2: Collection2,
_ collection3: Collection3,
_ collection4: Collection4,
_ collection5: Collection5,
...
_ collection14: Collection14
    ...
    value: Zip14SequenceDifferentiable<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Collection9, Collection10, Collection11, Collection12, Collection13, Collection14>,
    pullback: (Zip14SequenceDifferentiable<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Collection9, Collection10, Collection11, Collection12, Collection13, Collection14>.TangentVector) -> (Collection1.TangentVector, Collection2.TangentVector, Collection3.TangentVector, Collection4.TangentVector, Collection5.TangentVector, Collection6.TangentVector, Collection7.TangentVector, Collection8.TangentVector, Collection9.TangentVector, Collection10.TangentVector, Collection11.TangentVector, Collection12.TangentVector, Collection13.TangentVector, Collection14.TangentVector)
) where
...
Collection14: Differentiable,
Collection14.Element: Differentiable,
Collection14.TangentVector: DifferentiableCollection, // at least needs to be a collection to have an Element associatedtype
Collection14.TangentVector.Index == Int,
Collection14.TangentVector.Element == Collection14.Element.TangentVector{
    (
        value: differentiableZip(collection1, collection2, collection3, collection4, collection5, collection6, collection7, collection8, collection9, collection10, collection11, collection12, collection13, collection14),
        pullback: { v in
            (v.collection1, v.collection2, v.collection3, v.collection4, v.collection5, v.collection6, v.collection7, v.collection8, v.collection9, v.collection10, v.collection11, v.collection12, v.collection13, v.collection14)
        }
    )
}
...
var results14 = Collection14.TangentVector()
results14.reserveCapacity(v.count)
    ...
    for (tangentElement, pullback) in zip(v, pullbacks) {
        let (result1, result2, result3, result4, result5, result6, result7, result8, result9, result10, result11, result12, result13, result14) = pullback(tangentElement)
...
results14.appendContribution(of: result14)
                ...
                return TangentVector(results1, results2, results3, results4, results5, results6, results7, results8, results9, results10, results11, results12, results13, results14)
            }
        )
    }
}
...
Collection13.TangentVector.Index == Int,
Collection14: Differentiable,
Collection14.TangentVector: Collection,
Collection14.TangentVector.Index == Int
    {
        public typealias TangentVector = Self
        public typealias Element = (Collection1.TangentVector.Element, Collection2.TangentVector.Element, Collection3.TangentVector.Element, Collection4.TangentVector.Element, Collection5.TangentVector.Element, Collection6.TangentVector.Element, Collection7.TangentVector.Element, Collection8.TangentVector.Element, Collection9.TangentVector.Element, Collection10.TangentVector.Element, Collection11.TangentVector.Element, Collection12.TangentVector.Element, Collection13.TangentVector.Element, Collection14.TangentVector.Element)
        public typealias Index = Int
        ...
        @inlinable
        public var endIndex: Int { 
            Swift.min(collection1.count, collection2.count, collection3.count, collection4.count, collection5.count, collection6.count, collection7.count, collection8.count, collection9.count, collection10.count, collection11.count, collection12.count, collection13.count, collection14.count)
        }
        
        @inlinable
        public subscript(index: Int) -> Element {
            (collection1[index], collection2[index], collection3[index], collection4[index], collection5[index], collection6[index], collection7[index], collection8[index], collection9[index], collection10[index], collection11[index], collection12[index], collection13[index], collection14[index])
        }
...
@inlinable
public func differentiableZipWith<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Collection9, Collection10, Collection11, Collection12, Collection13, Collection14, Result>(_ c1: Collection1,
_ c2: Collection2,
_ c3: Collection3,
_ c4: Collection4,
_ c5: Collection5,
...
_ c12: Collection12,
_ c13: Collection13,
_ c14: Collection14,    with transform: @differentiable(reverse) (Collection1.Element, Collection2.Element, Collection3.Element, Collection4.Element, Collection5.Element, Collection6.Element, Collection7.Element, Collection8.Element, Collection9.Element, Collection10.Element, Collection11.Element, Collection12.Element, Collection13.Element, Collection14.Element) -> Result
) -> [Result] where
...
Collection13.Element: Differentiable,
Collection14: DifferentiableCollection,
Collection14.Element: Differentiable,    Result: Differentiable
{
    let capacity = min(c1.count, c2.count, c3.count, c4.count, c5.count, c6.count, c7.count, c8.count, c9.count, c10.count, c11.count, c12.count, c13.count, c14.count)
...
var c14i = c14.startIndex    
    for _ in 0 ..< capacity {
        results.append(transform(c1[c1i], c2[c2i], c3[c3i], c4[c4i], c5[c5i], c6[c6i], c7[c7i], c8[c8i], c9[c9i], c10[c10i], c11[c11i], c12[c12i], c13[c13i], c14[c14i]))
...
@inlinable
public func _vjpDifferentiableZipWith<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Collection9, Collection10, Collection11, Collection12, Collection13, Collection14, Result>(_ c1: Collection1,
_ c2: Collection2,
_ c3: Collection3,
_ c4: Collection4,
_ c5: Collection5,
...
{
    let count = min(c1.count, c2.count, c3.count, c4.count, c5.count, c6.count, c7.count, c8.count, c9.count, c10.count, c11.count, c12.count, c13.count, c14.count)
...
var c14i = c14.startIndex    
    for _ in 0 ..< count {
        let (value, pullback) = valueWithPullback(at: c1[c1i], c2[c2i], c3[c3i], c4[c4i], c5[c5i], c6[c6i], c7[c7i], c8[c8i], c9[c9i], c10[c10i], c11[c11i], c12[c12i], c13[c13i], c14[c14i], of: transform)
...
results14.appendContribution(of: v14)
            ...
            return (results1, results2, results3, results4, results5, results6, results7, results8, results9, results10, results11, results12, results13, results14)
        }
    )
}
