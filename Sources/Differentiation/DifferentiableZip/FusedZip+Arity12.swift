...
@inlinable
public func fusedZip<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, Result>(
    _ c1: C1,
    _ c2: C2,
    _ c3: C3,
    _ c4: C4,
...
@inlinable
public func _vjpFusedZip<C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, Result>(
    _ c1: C1,
    _ c2: C2,
    _ c3: C3,
    _ c4: C4,
                                                ...
                                                gradients11Storage = [C11.Element.TangentVector](unsafeUninitializedCapacity: count) {
                                                    ...
                                                    gradients12Storage = [C12.Element.TangentVector](unsafeUninitializedCapacity: count) {
                                                        ...
                                                        for i in 0 ..< count {
                                                            ...
                                                            let (g1, g2, g3, g4, g5, g6, g7, g8, g9, g10, g11, g12) = pullback(1.0)
