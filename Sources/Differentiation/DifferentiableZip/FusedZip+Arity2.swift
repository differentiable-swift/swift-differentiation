...
@inlinable
public func fusedZip<C1, C2, Result>(
    _ c1: C1,
    _ c2: C2,
...
@inlinable
public func _vjpFusedZip<C1, C2, Result>(
    _ c1: C1,
    _ c2: C2,
    with transform: @differentiable(reverse) (
        C1.Element,
...
@inlinable
public func fusedZip<C1, C2, C3, C4, C5, C6, C7, C8, Result>(
    _ c1: C1,
    _ c2: C2,
    _ c3: C3,
    _ c4: C4,
...
@derivative(of: fusedZip)
@inlinable
public func _vjpFusedZip<C1, C2, C3, C4, C5, C6, C7, C8, Result>(
    _ c1: C1,
    _ c2: C2,
    _ c3: C3,
    _ c4: C4,
                                ...
                                gradients7Storage = [C7.Element.TangentVector](unsafeUninitializedCapacity: count) { gradients7Buffer,
                                    ...
                                    gradients8Storage = [C8.Element.TangentVector](unsafeUninitializedCapacity: count) { gradients8Buffer,
                                        ...
                                        for i in 0 ..< count {
                                            ...
                                            let (g1, g2, g3, g4, g5, g6, g7, g8) = pullback(1.0)
