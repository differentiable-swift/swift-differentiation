// MARK: Zip8SequenceDifferentiable@inlinable
public func differentiableZip<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8>(_ collection1: Collection1,
...
) -> Zip8SequenceDifferentiable<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8> {
    Zip8SequenceDifferentiable(collection1, collection2, collection3, collection4, collection5, collection6, collection7, collection8)
}

@frozen
public struct Zip8SequenceDifferentiable<Collection1: Collection, Collection2: Collection, Collection3: Collection, Collection4: Collection, Collection5: Collection, Collection6: Collection, Collection7: Collection, Collection8: Collection> where Collection1.Index == Int, Collection2.Index == Int, Collection3.Index == Int, Collection4.Index == Int, Collection5.Index == Int, Collection6.Index == Int, Collection7.Index == Int, Collection8.Index == Int {@usableFromInline
...
_ collection6: Collection6,
_ collection7: Collection7,
_ collection8: Collection8    ) {self._collection1 = collection1
...
extension Zip8SequenceDifferentiable: Collection {
    public typealias Element = (Collection1.Element, Collection2.Element, Collection3.Element, Collection4.Element, Collection5.Element, Collection6.Element, Collection7.Element, Collection8.Element)
    ...
    public var endIndex: Int {
        Swift.min(_collection1.count, _collection2.count, _collection3.count, _collection4.count, _collection5.count, _collection6.count, _collection7.count, _collection8.count)
    }
    
    @inlinable
    public subscript(index: Int) -> Element {
        (_collection1[index], _collection2[index], _collection3[index], _collection4[index], _collection5[index], _collection6[index], _collection7[index], _collection8[index])
    }
...
extension Zip8SequenceDifferentiable: Sendable where Collection1: Sendable,
...
@inlinable
public func _vjpDifferentiableZip<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8>(_ collection1: Collection1,
_ collection2: Collection2,
_ collection3: Collection3,
_ collection4: Collection4,
_ collection5: Collection5,
...
_ collection8: Collection8
    ...
    value: Zip8SequenceDifferentiable<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8>,
    pullback: (Zip8SequenceDifferentiable<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8>.TangentVector) -> (Collection1.TangentVector, Collection2.TangentVector, Collection3.TangentVector, Collection4.TangentVector, Collection5.TangentVector, Collection6.TangentVector, Collection7.TangentVector, Collection8.TangentVector)
) where
...
Collection8.TangentVector.Element == Collection8.Element.TangentVector{
    (
        value: differentiableZip(collection1, collection2, collection3, collection4, collection5, collection6, collection7, collection8),
        pullback: { v in
            (v.collection1, v.collection2, v.collection3, v.collection4, v.collection5, v.collection6, v.collection7, v.collection8)
        }
    )
}
...
_collection8.move(by: offset.collection8)    }
    ...
    @inlinable
    public func differentiableMap<Result: Differentiable>(_ transform: @differentiable(reverse) (Collection1.Element, Collection2.Element, Collection3.Element, Collection4.Element, Collection5.Element, Collection6.Element, Collection7.Element, Collection8.Element) -> Result
    ) -> [Result] {
        self.map(transform)
    }
    ...
    @inlinable
    public func _vjpDifferentiableMap<Result: Differentiable>(_ transform: @differentiable(reverse) (Collection1.Element, Collection2.Element, Collection3.Element, Collection4.Element, Collection5.Element, Collection6.Element, Collection7.Element, Collection8.Element) -> Result
    ) -> (value: [Result], pullback: ([Result].TangentVector) -> TangentVector) {
        var results: [Result] = []
        results.reserveCapacity(self.count)
        var pullbacks: [(Result.TangentVector) -> (Collection1.Element.TangentVector, Collection2.Element.TangentVector, Collection3.Element.TangentVector, Collection4.Element.TangentVector, Collection5.Element.TangentVector, Collection6.Element.TangentVector, Collection7.Element.TangentVector, Collection8.Element.TangentVector)] = []
        pullbacks.reserveCapacity(self.count)

        for parameters in self {
            let (value, pullback) = valueWithPullback(at: parameters.0, parameters.1, parameters.2, parameters.3, parameters.4, parameters.5, parameters.6, parameters.7, of: transform)
...
results8.reserveCapacity(v.count)
    ...
    for (tangentElement, pullback) in zip(v, pullbacks) {
        let (result1, result2, result3, result4, result5, result6, result7, result8) = pullback(tangentElement)
...
results8.appendContribution(of: result8)
                ...
                return TangentVector(results1, results2, results3, results4, results5, results6, results7, results8)
            }
        )
    }
}
...
Collection8.TangentVector.Index == Int
    {
        ...
        public typealias Element = (Collection1.TangentVector.Element, Collection2.TangentVector.Element, Collection3.TangentVector.Element, Collection4.TangentVector.Element, Collection5.TangentVector.Element, Collection6.TangentVector.Element, Collection7.TangentVector.Element, Collection8.TangentVector.Element)
        public typealias Index = Int
        ...
        @inlinable
        public var endIndex: Int { 
            Swift.min(collection1.count, collection2.count, collection3.count, collection4.count, collection5.count, collection6.count, collection7.count, collection8.count)
        }
        
        @inlinable
        public subscript(index: Int) -> Element {
            (collection1[index], collection2[index], collection3[index], collection4[index], collection5[index], collection6[index], collection7[index], collection8[index])
        }
...
@inlinable
public func differentiableZipWith<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Result>(_ c1: Collection1,
_ c2: Collection2,
_ c3: Collection3,
_ c4: Collection4,
_ c5: Collection5,
_ c6: Collection6,
_ c7: Collection7,
_ c8: Collection8,    with transform: @differentiable(reverse) (Collection1.Element, Collection2.Element, Collection3.Element, Collection4.Element, Collection5.Element, Collection6.Element, Collection7.Element, Collection8.Element) -> Result
) -> [Result] where
...
Collection8.Element: Differentiable,    Result: Differentiable
{
    let capacity = min(c1.count, c2.count, c3.count, c4.count, c5.count, c6.count, c7.count, c8.count)
...
var c8i = c8.startIndex    
    for _ in 0 ..< capacity {
        results.append(transform(c1[c1i], c2[c2i], c3[c3i], c4[c4i], c5[c5i], c6[c6i], c7[c7i], c8[c8i]))
...
@inlinable
public func _vjpDifferentiableZipWith<Collection1, Collection2, Collection3, Collection4, Collection5, Collection6, Collection7, Collection8, Result>(_ c1: Collection1,
_ c2: Collection2,
_ c3: Collection3,
_ c4: Collection4,
_ c5: Collection5,
...
_ c7: Collection7,
_ c8: Collection8,    with transform: @differentiable(reverse) (Collection1.Element, Collection2.Element, Collection3.Element, Collection4.Element, Collection5.Element, Collection6.Element, Collection7.Element, Collection8.Element) -> Result
) -> (value: [Result], pullback: ([Result].TangentVector) -> (Collection1.TangentVector, Collection2.TangentVector, Collection3.TangentVector, Collection4.TangentVector, Collection5.TangentVector, Collection6.TangentVector, Collection7.TangentVector, Collection8.TangentVector)) where
Collection1: DifferentiableCollection,
Collection1.Element: Differentiable,
Collection2: DifferentiableCollection,
Collection2.Element: Differentiable,
...
{
    let count = min(c1.count, c2.count, c3.count, c4.count, c5.count, c6.count, c7.count, c8.count)
    
    if count == 0 {
        return (value: [], pullback: { v in (Collection1.TangentVector(), Collection2.TangentVector(), Collection3.TangentVector(), Collection4.TangentVector(), Collection5.TangentVector(), Collection6.TangentVector(), Collection7.TangentVector(), Collection8.TangentVector()) })
    }
...
var c8i = c8.startIndex    
    for _ in 0 ..< count {
        let (value, pullback) = valueWithPullback(at: c1[c1i], c2[c2i], c3[c3i], c4[c4i], c5[c5i], c6[c6i], c7[c7i], c8[c8i], of: transform)
